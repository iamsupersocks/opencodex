...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      social: [
        { icon: "github", label: "GitHub", href: "https://github.com/iamsupersocks/opencodex" },
      ],
      editLink: {
        baseUrl: "https://github.com/iamsupersocks/opencodex/edit/main/docs-site/",
      },
      lastUpdated: true,
      // English at the site root; Korean under /ko, Simplified Chinese under /zh-cn, Traditional Chinese under /zh-tw, Russian under /ru, Japanese under /ja.
      defaultLocale: "root",
      locales: {
